                ...
                <div class="tab-content active" id="personal-tab">
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <div class="input-container">
                                <input type="text" id="fullName" class="form-input" placeholder="Enter rider's full name" name='Fullname'value='{{$riderdata->Fullname}}' autocomplete="name">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-container">
                                <input type="email" id="email" class="form-input"value='{{$riderdata->Email}}' name="Email" autocomplete="email">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <div class="input-container">
                                <input type="tel" id="phone" value='{{$riderdata->Phone}}' class="form-input" placeholder="Enter 10-digit phone number" name="Phone" autocomplete="tel">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-container">
                                <input type="date" id="dob" value='{{$riderdata->DateOfBirth}}' class="form-input" autocomplete="bday" name="DateOfBirth">
                ...
                <div class="tab-content" id="employment-tab">
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <div class="input-container">
                                <input type="date" value='{{$riderdata->HireDate}}'id="hireDate" class="form-input" name="HireDate">
   ...
   <select id="vehicleType" class="form-select" name="VehicleType">
    ...
    <option value="delivery van" {{ $riderdata->VehicleType == 'delivery van' ? 'selected' : '' }}>Delivery Van</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-container">
                                <input type="text" id="plateNumber" value='{{$riderdata->PlateNumber}}' class="form-input" placeholder="Enter license plate number" name="PlateNumber">
