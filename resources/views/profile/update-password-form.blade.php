<x-form-section submit="updatePassword">
    <!-- Title -->
    <x-slot name="title">
        <span class="text-red-600 font-bold text-xl">{{ __('Update Password') }}</span>
    </x-slot>

    <!-- Description -->
    <x-slot name="description">
        <span class="text-gray-700">{{ __('Ensure your account is using a long, random password to stay secure.') }}</span>
    </x-slot>
